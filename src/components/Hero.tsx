...
const Hero = () => {
  ...
  return (
    <div className="hero   md:mt-2 md:h-[24rem] ">
      <div className="md:ml-4 hero-content flex-col lg:flex-row-reverse">
        ...
        <a className="md:hidden font-semibold">Take a look at our <span onClick={goToProducts} className="font-bold underline">products</span>!</a>
